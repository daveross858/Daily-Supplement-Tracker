...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setCurrentDate(prevDate => {
        if (prevDate !== today) {
          // Reset all supplements for the new day by using functional update
          setSupplements(prevSupplements => {
            const resetSupplements = prevSupplements.map(s => ({ ...s, completed: false }))
            updateUserTodaysData(user.id, resetSupplements)
            return resetSupplements
          })
          return today
        }
        return prevDate
  ...
  // The rest of the component logic continues here...
                      ...
                      <div className="max-h-60 overflow-y-auto space-y-2">
                        {filteredSupplements.length === 0 ? (
                          ...
                          <>
                            ...
                            {/* Add to Library Button - Inside scrollable area */}
                            <div className="pt-2 mt-4 border-t border-gray-200">
                              <button
                                onClick={() => {
                                  // Navigate to library page to add new supplement
